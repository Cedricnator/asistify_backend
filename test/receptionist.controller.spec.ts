    ...
    it('should create a new receptionist', () => {
      ...
      return request(app.getHttpServer())
        ...
        .expect((res) => {
          ...
          expect(res.body.levelFormality).toBe(createDto.levelFormality);
      ...
      if (receptionists.length > 0) {
        ...
        return request(app.getHttpServer())
          ...
          .expect((res) => {
            ...
            expect(res.body.levelFormality).toBe(updateData.levelFormality);
          });
      }
    });
    ...
    it('should return 409 when receptionist has dependencies', async () => {
      ...
      if (receptionistWithMetrics) {
        return request(app.getHttpServer())
          ...
          .expect(409)
          .expect((res) => {
            expect(res.body.error).toBe('ReceptionistHasDependencies');
          });
      }
    });
  });
